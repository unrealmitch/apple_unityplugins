...
SWIFT_EXTERN void GKAchievementDescription_LoadImage(void * _Nonnull pointer, int64_t taskId, NSInteger photoSize, void (* _Nonnull onImageLoaded)(int64_t, int32_t, int32_t, uint8_t * _Nonnull, int32_t), void (* _Nonnull onError)(int64_t, void * _Nonnull));
...
SWIFT_EXTERN void GKLeaderboardSet_LoadImage(void * _Nonnull pointer, int64_t taskId, void (* _Nonnull onImageLoaded)(int64_t, int32_t, int32_t, uint8_t * _Nonnull, int32_t), void (* _Nonnull onError)(int64_t, void * _Nonnull));
...
SWIFT_EXTERN void GKLeaderboard_LoadImage(void * _Nonnull pointer, int64_t taskId, void (* _Nonnull onImageLoaded)(int64_t, int32_t, int32_t, uint8_t * _Nonnull, int32_t), void (* _Nonnull onError)(int64_t, void * _Nonnull));


SWIFT_EXTERN void GKLeaderboard_LoadLeaderboards(void * _Nonnull pointer, int64_t taskId, void (* _Nonnull onSuccess)(int64_t, void * _Nullable), void (* _Nonnull onError)(int64_t, void * _Nonnull));
...
SWIFT_EXTERN void GKLocalPlayer_FetchItems(int64_t taskId, void (* _Nonnull onSuccess)(int64_t, int8_t * _Nonnull, uint8_t * _Nonnull, int32_t, uint8_t * _Nonnull, int32_t, NSUInteger), void (* _Nonnull onError)(int64_t, void * _Nonnull));
...
SWIFT_EXTERN void GKLocalPlayer_LoadFriendsAuthorizationStatus(void * _Nonnull pointer, int64_t taskId, void (* _Nonnull onSuccess)(int64_t, NSInteger), void (* _Nonnull onError)(int64_t, void * _Nonnull));
...
SWIFT_EXTERN void GKMatchDelegate_SetDidFailWithError(void * _Nonnull pointer, void (* _Nonnull callback)(void * _Nonnull, void * _Nonnull, GKPlayerConnectionState));
...
SWIFT_EXTERN void GKMatchRequest_SetRecipients(void * _Nonnull pointer, void * _Nonnull value);
...
SWIFT_EXTERN int8_t * _Nonnull GKPlayer_GetPlayerId(void * _Nonnull pointer) SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_EXTERN void GKPlayer_LoadPhoto(void * _Nonnull pointer, int64_t taskId, NSInteger photoSize, void (* _Nonnull onImageLoaded)(int64_t, int32_t, int32_t, uint8_t * _Nonnull, int32_t), void (* _Nonnull onError)(int64_t, void * _Nonnull));
